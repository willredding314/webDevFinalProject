    ...
    return (
        <div className="w-full mb-4 rounded-lg bg-gray-50">
            <div className="px-4 py-2 bg-white border rounded-lg border-eerie-dark/20">
                <textarea id="comment" rows={rows} className="w-full px-0 text-sm text-gray-900 bg-white border-0 focus:ring-0 " placeholder={placeholder} required onChange={handleChange} value={comment} />
            </div>
